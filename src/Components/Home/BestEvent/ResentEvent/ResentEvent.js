                    ...
                    <div className="flex flex-wrap -m-1 md:-m-2">
                        <div className="flex flex-wrap w-1/2">
                            ...
                            <div className="w-1/2 p-1 md:p-2">
                                <img alt="ResentEvent" className="block object-cover object-center w-full h-full rounded-lg" src="https://i.ibb.co/k9Y7gPF/7.jpg" />
                            </div>
                            ...
                            <div className="w-full p-1 md:p-2">
                                {/* <img alt="ResentEvent" className="block object-cover object-center w-full h-full rounded-lg"
                                    src="https://i.ibb.co/5j9cdzD/5.jpg" /> */}
                                     <video autoPlay loop muted className="block object-cover  w-full h-full rounded-lg" src={video_2}>
