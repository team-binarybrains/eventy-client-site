      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-5">
        <div className="mb-4 cursor-pointer">
          <div className="relative overflow-hidden bg-no-repeat bg-cover max-w-xs">
            <img
              src="https://i.ibb.co/fSkLx14/marrige.webp"
              className="max-w-xs"
              alt="Louvre"
            />
        ...
        <div className="mb-4 cursor-pointer">
          <div className="relative overflow-hidden bg-no-repeat bg-cover max-w-xs">
            <img
              src="https://i.ibb.co/vqZ2qKw/fashion.webp"
              className="max-w-xs h-[213px]"
              alt="Louvre"
            />
        ...
        <div className="mb-4 cursor-pointer">
          <div className="relative overflow-hidden bg-no-repeat bg-cover max-w-xs">
            <img
              src="https://i.ibb.co/t2pj2VC/iftar.jpg"
              className="max-w-xs h-[215px]"
              alt="Louvre"
            />
        ...
        <div className="mb-4 cursor-pointer">
          <div className="relative overflow-hidden bg-no-repeat bg-cover max-w-xs">
            <img
              src="https://i.ibb.co/XVhFNcB/crits.jpg"
              className="max-w-xs"
              alt="Louvre"
            />
        ...
        <div className="mb-4 cursor-pointer">
          <div className="relative overflow-hidden bg-no-repeat bg-cover max-w-xs">
            <img
              src="https://i.ibb.co/2v1Sg87/Birthday.jpg"
              className="max-w-xs h-[215px] w-[400px]"
              alt="Louvre"
            />
        ...
        <div className="mb-4 cursor-pointer">
          <div className="relative overflow-hidden bg-no-repeat bg-cover max-w-xs">
            <img
              src="https://i.ibb.co/M7L8JXM/eid.jpg"
              className="max-w-xs h-[215px] w-[400px]"
              alt="Louvre"
            />
