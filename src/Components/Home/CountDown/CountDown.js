...
export default function CountDown() {
  ...
  const CountDownComponents = Object.keys(timeLeft).map((interval) => {
    ...
    return (
      <span className="text-green-400 text-xl  mb-3  font-bold shadow-lg shadow-stone-500 bg-white mx-1 mt-3 md:inline-block  rounded-full p-5 justify-items-center">
